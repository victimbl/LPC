...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos, groups, collision_sprites, player_sprites, powerups_sprites, id_num):
        ...
        self.powerup_sprites = powerups_sprites
    ...
    def update(self):
        ...
        if self.is_moving and not self.on_air and not self.is_dead:
        ...
        hits = pygame.sprite.spritecollide(self, self.powerup_sprites, True)
        for hit in hits:
            if hit.type == 'life':
                self.lives += 1
            if hit.type == 'invis':
